    ...
    <footer className='flex md:flex-row flex-col w-full bg-zinc-900 relative bottom-0 text-white '>
        <div className='flex w-full justify-around items-center my-5'>
            <div className='flex flex-col'>
                <a href='https://www.fpotc.com' target='_blank'><img src={fpotc} className='w-24 md:w-48 h-auto' /></a>
            </div>
            <div className='flex flex-col text-end items-end'>
                ...
                <div className='flex'>
                  <a className='m-2 text-xl cursor-pointer text-zinc-400 hover:text-white'><BsInstagram /></a>
                  <a href='https://www.linkedin.com/in/jennifer-henderson-260849108/' target='_blank' className='m-2 text-xl cursor-pointer text-zinc-400 hover:text-white'><BsLinkedin /></a>
                  <a href='https://www.facebook.com/FirstProperties/' target='_blank' className='m-2 text-xl cursor-pointer text-zinc-400 hover:text-white'><BsFacebook /></a>
                </div>
