    ...
    <div className='flex flex-col relative'>
        ...
        <div className='flex items-center'>
          <div className='absolute z-10 flex flex-col items-center w-full'>
            <h1 className='text-4xl md:text-6xl text-black pt-8 md:pt-4 font-playfair font-semibold flex'>Jennifer Henderson</h1>
            <h2 className='md:text-lg text-black font-karla uppercase pt-4 text-center'>A Transparent Real Estate Experience</h2>
        </div>
          
          <video className='w-full brightness-50 opacity-75 bg-black' src={drone} autoPlay muted loop/>
        </div>
